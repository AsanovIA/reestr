...
'use strict';
{
    const DateTimeShortcuts = {
        ...
        requestDate: function(num) {
            if (DateTimeShortcuts.calendarInputs[num].classList.contains('vDateFieldRequest')) {
                let path = window.location.pathname;
                let value = DateTimeShortcuts.calendarInputs[num].value;
                window.location.href = `${path}?date=${value}`;
            }
        },
        handleCalendarCallback: function(num) {
            ...
            return function(y, m, d) {
                ...
                document.getElementById(DateTimeShortcuts.calendarDivName1 + num).style.display = 'none';
                DateTimeShortcuts.requestDate(num);
            };
        },
