...
#
#
# class Podrad(models.Model):
#     status = models.CharField(max_length=255)
#
#
# class StageUst(models.Model):
#     status = models.CharField(max_length=255)
#
#
# class IncomeManny(models.Model):
#     status = models.CharField(max_length=255)
#


# 12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456120



# INCOMING = 1
# OUTGOING = 2
# choices_letter_status = [(INCOMING, 'входящее'), (OUTGOING, 'исходящее')]
# class Letter(models.Model):
#     status = models.PositiveSmallIntegerField('Статус', blank=True, null=True, choices=choices_letter_status)
#
# class LetterForm(forms.ModelForm):
#     from .models import choices_letter_status
#
#     choices_letter = [(0, '-----')] + choices_letter_status
#     status = forms.ChoiceField(choices=choices_letter, required=False, label='Статус')
#     class Meta:
#         model = Letter
...
#     member = models.ForeignKey(Member, on_delete=models.CASCADE, blank=True, null=True, verbose_name='Сотрудник')
#     contract = models.ForeignKey(Contract, on_delete=models.CASCADE, blank=True, null=True, verbose_name='Проект')
#     time = models.DecimalField(decimal_places=1, blank=True, verbose_name='Время')
# как при выборе contract выводить список уникальных member с полем sum_work в котором будет просуммированно значение time для каждого member