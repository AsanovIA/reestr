...
class LogEntrySite(models.Model):
    ...
    def __str__(self):
        if self.is_addition():
            ...
            return gettext("Closed “%(object)s.”") % {
                "object": self.object_repr
            }
    ...
    def is_closing(self):
        return self.action_flag == CLOSING
    ...
    def get_change_message(self):
        ...
        if self.change_message and self.change_message[0] == "[":
            ...
            for sub_message in change_message:
                ...
                elif "closed" in sub_message:
                    sub_message["closed"]["name"] = gettext(
                        sub_message["closed"]["name"]
                    )
                    messages.append(
                        gettext("Closed {name} “{object}”.").format(
                            **sub_message["closed"]
                        )
                    )
