...
from users.forms import AdminUserProfileCreationForm
...
class UserProfileAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Персональная информация', {'fields': (
            'last_name', 'first_name', 'middle_name', 'username', 'email'
        )}),
        ...
        ('Краткая история', {'fields': ('last_change',)}),
    )
    add_fieldsets = (
        (None, {'classes': ('wide',),
                'fields': (
    ...
    short_name.short_description = 'Short Name 222'
